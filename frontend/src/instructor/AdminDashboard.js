...
const AdminDashboard = () => {
  ...
  const handleDelete = async (userId) => {
    if (window.confirm("Are you sure you want to delete this user?")) {
      try {
        await axios.delete(
          `http://127.0.0.1:8000/api/admin/users/${userId}/delete/`
        ); // Updated path
  ...
  return (
    <Container className="mt-4">
      ...
      <Button variant="primary" className="mb-3" onClick={handleCreateAccount}>
        Create Account
      </Button>
              ...
              <td className="align-items-center justify-content-center">
                <div className="d-flex gap-2">
                  <Button
                    ...
                    style={{ width: "32px", height: "32px" }} // Ensure uniform size
                  >
